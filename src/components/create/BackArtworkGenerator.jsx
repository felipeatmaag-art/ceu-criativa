...
export default function BackArtworkGenerator({ frontImage, description, backImage, onGenerated }) {
  ...
  return (
    <div className="mt-4 rounded-2xl border border-ceu-navy/10 bg-ceu-navy/5 p-4">
      <Button onClick={generateBack} disabled={isGenerating} className="w-full rounded-xl bg-ceu-navy text-ceu-cloud hover:bg-ceu-navy/90">
