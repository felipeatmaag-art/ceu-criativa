...
export default function ProductActionsMenu({ product, onEdit, onDeleted }) {
  ...
  return <>
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-40 rounded-xl">
        <DropdownMenuItem onSelect={onEdit} className="cursor-pointer"><Pencil className="mr-2 h-4 w-4" />Editar</DropdownMenuItem>
