  ...
  return Promise.all(items.map(async item => {
    ...
    if (production) {
      ...
      if (production.catalog_product_id) {
        ...
        unitPrice = Math.round(quote.unit_price * 100);
    ...
    return {
      ...
      base_cost: quote.base_cost, design_price: quote.design_price, artist_commission_rate: quote.artist_commission_rate,
      artist_commission: quote.artist_commission, platform_margin: quote.platform_margin,
